...
- Three voice modes against Gemini STT/TTS: text-only, push-to-talk,
...
- Weekly action plans generated by Gemini
...
## Stack
Next.js 14 (App Router) · React 18 · TypeScript · Tailwind CSS · Supabase · Gemini · Vercel
...
3. **Configure environment variables**
   ...
   env-var list (Gemini models, INTERNAL_CRON_SECRET, Sentry, etc.) see
